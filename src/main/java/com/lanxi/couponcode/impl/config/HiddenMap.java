...
public interface HiddenMap {
    ...
    static void initAdmin() {
        ADMIN_ACCOUNT.put("merchantName","商户名称");
...
//        ADMIN_COMMODITY.put("description", "使用说明");
        ...
        ADMIN_MERCHANT.put("serveExplain", "服务或商品说明");
        ADMIN_MERCHANT.put("registerAddress", "注册地址");
        ADMIN_MERCHANT.put("minuteRegisterAddress", "注册详细地址");
        ADMIN_MERCHANT.put("oraganizingCode", "组织机构代码");
        ADMIN_MERCHANT.put("charterCode", "营业执照编号");
        ADMIN_MERCHANT.put("principal", "法定代表人");
        ADMIN_MERCHANT.put("linkMan", "联系人姓名");
        ADMIN_MERCHANT.put("linkManPhone", "联系人手机号码");
        ADMIN_MERCHANT.put("serviceTel", "客服电话");
        ADMIN_MERCHANT.put("email", "电子邮箱");
        ADMIN_MERCHANT.put("organizingInstitutionBarCodePic", "组织机构代码证");
        ADMIN_MERCHANT.put("businessLicensePic", "工商营业执照");
        ADMIN_MERCHANT.put("otherPic", "其他证明材料");
...
//        MERCHANTMANAGER_COMMODITY.put("description", "使用说明");
        ...
        MERCHANTMANAGER_VERIFY.put("facePrice", "商品面值");
        MERCHANTMANAGER_VERIFY.put("clearStatus", "清算状态");

        MERCHANTMANAGER_MERCHANT.put("merchantId", "商户编号");
        MERCHANTMANAGER_MERCHANT.put("merchantName", "商户名称");
        MERCHANTMANAGER_MERCHANT.put("merchantStatus", "商户状态");
        MERCHANTMANAGER_MERCHANT.put("createTime", "信息提交时间");
        MERCHANTMANAGER_MERCHANT.put("workAddress", "办公地址");
        MERCHANTMANAGER_MERCHANT.put("minuteWorkAddress", "办公详细地址");
        MERCHANTMANAGER_MERCHANT.put("serveExplain", "服务或商品说明");
        MERCHANTMANAGER_MERCHANT.put("registerAddress", "注册地址");
        MERCHANTMANAGER_MERCHANT.put("minuteRegisterAddress", "注册详细地址");
        MERCHANTMANAGER_MERCHANT.put("oraganizingCode", "组织机构代码");
        MERCHANTMANAGER_MERCHANT.put("charterCode", "营业执照编号");
        MERCHANTMANAGER_MERCHANT.put("principal", "法定代表人");
        MERCHANTMANAGER_MERCHANT.put("linkMan", "联系人姓名");
        MERCHANTMANAGER_MERCHANT.put("linkManPhone", "联系人手机号码");
        MERCHANTMANAGER_MERCHANT.put("serviceTel", "客服电话");
        MERCHANTMANAGER_MERCHANT.put("email", "电子邮箱");
        MERCHANTMANAGER_MERCHANT.put("organizingInstitutionBarCodePic", "组织机构代码证");
