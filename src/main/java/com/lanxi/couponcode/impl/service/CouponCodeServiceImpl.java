...
public class CouponCodeServiceImpl implements CouponCodeService {
    ...
    public Boolean verificateCode(Long merchantId, Long shopId, Long commodityId, Long operaterId,
        ...
        try {
            ...
            CouponCode couponCode = queryCouponCode(merchantId, code);
...
//    }
    ...
    public Boolean destroyCode(Long codeId, Long operaterId, String operaterInfo, String operaterPhone) {
        ...
        if(code==null)
            ...
            return destroyCode(code.getMerchantId(),code.getCode(),operaterId,operaterInfo,operaterPhone);
    }
    ...
    public List<CouponCode> queryCouponCode(String createTimeStart, String createTimeEnd, String merchantName,
        ...
        try {
            ...
            if(page==null)
                list = daoService.getCouponCodeDao().selectList(wrapper);
            else
                list = daoService.getCouponCodeDao().selectPage(page,wrapper);
