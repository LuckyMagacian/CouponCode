...
public class MerchantServiceController implements com.lanxi.couponcode.spi.service.MerchantService{
    ...
    public RetMessage<Boolean> inputMerchantInfo(String merchantName, String serviceDistription, String workAddress,
    	...
    	try {
    		...
    		merchant.setMerchantId(merchantId);
			result=merchantService.fillInInformation(merchant, organizingInstitutionBarCodePic, businessLicensePic, otherFile);
			if(result) {
				retMessage.setRetCode(RetCodeEnum.success.getValue());
    ...
    @Override
    public RetMessage<Boolean> modifyMerchantInfo(String merchantName, 
    		String serviceDistription, String workAddress,
    		String minuteWorkAddress,String businessLicenseNum, 
    		String organizingInstitutionBarCode, String enterpriseLegalRepresentativeName, 
    		String contactsName, String contactPhone, String serviceTel, String contactEmail, 
    		File organizingInstitutionBarCodePic, File businessLicensePic, File otherFile, 
